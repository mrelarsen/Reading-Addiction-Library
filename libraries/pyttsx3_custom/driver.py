...
import weakref
import importlib
from .drivers.sapi5 import buildDriver;
...
class DriverProxy(object):
    ...
    def __init__(self, engine, driverName, debug):
        ...
        name = 'libraries.pyttsx3_custom.drivers.%s' % driverName
    ...
    def toggle_pause(self, pause = None):
        '''
        Called by the engine to pause or resume the current utterance.
        '''
        return self._driver.toggle_pause(pause);
